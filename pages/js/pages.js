(function($) {
  ...
  /** @function initBackgeroundVoronoi
   * @description Initialize initBackgeroundVoronoi
   * @param none
   * @requires https://d3js.org/d3.v4.min.js
   */
  Pages.prototype.initBackgeroundVoronoi = function() {
...
console.info('Data: ', svg);

    console.info('Data: ', width);

    var sites = d3.range(200)
      .map(function(d) { return [Math.random() * width, Math.random() * height]; });

    var voronoi = d3.voronoi()
      .extent([[-2, -1], [width + 1, height + 1]]);
